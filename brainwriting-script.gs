...
const imageUrl = "";
const colabGitHubUrl = "https://colab.research.google.com/github/mberkancetin/startup_success_predictor/blob/main/notebooks/berkan-encoder.ipynb";
